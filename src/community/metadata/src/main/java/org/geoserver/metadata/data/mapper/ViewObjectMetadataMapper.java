...
/**
 * Convert between the persisted model en the view model.
 *
 * The view contains a MetadataMap with complex Objects.
 * The Database only stores a MetadataMap with Strings or List<String>.
 */
public class ViewObjectMetadataMapper implements Serializable {

    public void toPersistedModel(IModel<MetadataMap> metadataModel) {
    ...
    public  MetadataMap toViewModel(IModel<MetadataMap> metadataModel) {
        List<String> keysToDelete = new ArrayList<>();
